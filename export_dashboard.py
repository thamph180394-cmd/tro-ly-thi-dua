...
def xoa_noi_dung_dong(img):
    ...
    # 6 Ô TỔNG QUAN
    #
    # Chỉ xóa vùng số liệu;
    # giữ nguyên biểu tượng + tiêu đề của mẫu.
    # -----------------------------------------------------
...
def ve_thong_tin_dau(
    ...
    lop_tien_bo, chi_tiet_tien_bo = (
        tim_tien_bo(df)
    )

    lop_on_dinh, chi_tiet_on_dinh = (
        tim_on_dinh(df)
    )
...
def tao_anh_dashboard(
    ...
    if not TEMPLATE_PATH.exists():
        ...
        raise FileNotFoundError(
            "Không tìm thấy file:\n"
            f"{TEMPLATE_PATH}\n\n"
            "Hãy kiểm tra lại thư mục assets "
            "và tên dashboard_template.png"
        )
    ...
    # =====================================================
    # TEMPLATE CHUẨN 1102 x 715
    # Nếu kích thước khác sẽ đưa về đúng chuẩn
    # =====================================================
